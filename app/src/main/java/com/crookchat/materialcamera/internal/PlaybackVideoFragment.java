...
import com.crookchat.easyvideoplayer.EasyVideoCallback;
import com.crookchat.easyvideoplayer.EasyVideoPlayer;
...
public class PlaybackVideoFragment extends Fragment
  ...
  public static PlaybackVideoFragment newInstance(
    ...
    args.putBoolean(com.crookchat.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, allowRetry);
    args.putInt(com.crookchat.materialcamera.internal.CameraIntentKey.PRIMARY_COLOR, primaryColor);
  ...
  public void onViewCreated(View view, Bundle savedInstanceState) {
    ...
    if (getArguments().getBoolean(com.crookchat.materialcamera.internal.CameraIntentKey.ALLOW_RETRY, true))
