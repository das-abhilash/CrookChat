...
import com.crookchat.Login.LoginActivity;
...
import com.crookchat.Utils.SectionsPagerAdapter;
import com.crookchat.Utils.UniversalImageLoader;
import com.crookchat.Utils.ViewCommentsFragment;
import com.crookchat.models.Media;
import com.crookchat.opengl.AddToStoryDialog;
import com.crookchat.opengl.NewStoryActivity;
...
public class HomeActivity extends AppCompatActivity implements
    ...
    public void onCommentThreadSelected(Media media, String callingActivity){
        Log.d(TAG, "onCommentThreadSelected: selected a coemment thread");

        ViewCommentsFragment fragment  = new ViewCommentsFragment();
        Bundle args = new Bundle();
        args.putParcelable(getString(R.string.photo), media);
...
//        tabLayout.getTabAt(0).setIcon(R.drawable.ic_camera);
        tabLayout.getTabAt(0).setIcon(R.drawable.ic_communication);
